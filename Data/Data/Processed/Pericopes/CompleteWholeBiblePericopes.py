...
current_per_record["WholeText"] = ""

for ref in refs:
    v_dict = get_verse_dict_by_ref(verses, ref.strip())
    current_per_record["Verses"].append(v_dict)
    current_per_record["WholeText"] += ' ' +  v_dict['Text']       
